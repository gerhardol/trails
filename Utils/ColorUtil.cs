...
namespace TrailsPlugin.Utils
{
    ...
    public static class ColorUtil
    {
        ...
        //TotalHemoglobinConcentration,   FF533D FF533D FDD3C9 FEA597
                ...
                {LineChartTypes.Pace2,                        new ChartColors(Color.FromArgb(0x20, 0x4A, 0x87), Color.FromArgb(0x78, 0x89, 0x9a, 0xb7), Color.FromArgb(0xc8, 0x89, 0x9a, 0xb7))},
                ...
                {LineChartTypes.DevicePace2,                  new ChartColors(Color.FromArgb(0x3E, 0x41, 0x7A), Color.FromArgb(0x78, 0xC6, 0xCD, 0xD8), Color.FromArgb(0xc8, 0x94, 0xA7, 0xC2))},
