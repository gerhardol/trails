        ...
        public static readonly IDictionary<int, ChartColors> ResultColor = new Dictionary<int, ChartColors>()
            {
                ...
                { 6,  new ChartColors(Color.FromArgb(0xff, 0x88, 0x88, 0x88), Color.FromArgb(0x68, 0xdd, 0xdd, 0xdd),Color.FromArgb(0xc8, 0xbb, 0xbb, 0xbb)) },
                { 1,  new ChartColors(Color.FromArgb(0xff, 0xff, 0x00, 0x00), Color.FromArgb(0x68, 0xf0, 0xc0, 0xc0),Color.FromArgb(0xc8, 0xf0, 0xa0, 0xa0)) },
                { 9,  new ChartColors(Color.FromArgb(0xff, 0xff, 0x6a, 0x00), Color.FromArgb(0x68, 0xf0, 0xd0, 0x90),Color.FromArgb(0xc8, 0xf0, 0xb0, 0x70)) },
                { 3,  new ChartColors(Color.FromArgb(0xff, 0xe8, 0xc9, 0x00), Color.FromArgb(0x68, 0xee, 0xdd, 0xcc),Color.FromArgb(0xc8, 0xff, 0xee, 0x77)) },
                { 12, new ChartColors(Color.FromArgb(0xff, 0xb2, 0xe1, 0x00), Color.FromArgb(0x68, 0xdd, 0xff, 0xcc),Color.FromArgb(0xc8, 0xcc, 0xff, 0x77)) },
                { 7,  new ChartColors(Color.FromArgb(0xff, 0x4c, 0xf0, 0x00), Color.FromArgb(0x68, 0xcc, 0xff, 0xcc),Color.FromArgb(0xc8, 0x99, 0xff, 0x77)) },
                { 0,  new ChartColors(Color.FromArgb(0xff, 0x00, 0xc2, 0x21), Color.FromArgb(0x68, 0xcc, 0xdd, 0xcc),Color.FromArgb(0xc8, 0x77, 0xee, 0x88)) },
                { 4,  new ChartColors(Color.FromArgb(0xff, 0x00, 0xf0, 0x8a), Color.FromArgb(0x68, 0xcc, 0xff, 0xdd),Color.FromArgb(0xc8, 0x77, 0xff, 0x99)) },
                { 13, new ChartColors(Color.FromArgb(0xff, 0x00, 0xf0, 0xf0), Color.FromArgb(0x68, 0xcc, 0xff, 0xff),Color.FromArgb(0xc8, 0x77, 0xff, 0xff)) },
                { 10, new ChartColors(Color.FromArgb(0xff, 0x00, 0x94, 0xff), Color.FromArgb(0x68, 0xcc, 0xdd, 0xff),Color.FromArgb(0xc8, 0x77, 0xcc, 0xff)) },
                { 2,  new ChartColors(Color.FromArgb(0xff, 0x00, 0x26, 0xff), Color.FromArgb(0x68, 0xcc, 0xdd, 0xff),Color.FromArgb(0xc8, 0x77, 0x88, 0xff)) },
                { 14, new ChartColors(Color.FromArgb(0xff, 0x48, 0x00, 0xff), Color.FromArgb(0x68, 0xcc, 0xcc, 0xff),Color.FromArgb(0xc8, 0x99, 0x77, 0xff)) },
                { 8,  new ChartColors(Color.FromArgb(0xff, 0xb2, 0x00, 0xff), Color.FromArgb(0x68, 0xdd, 0xcc, 0xff),Color.FromArgb(0xc8, 0xee, 0x77, 0xff)) },
                { 5,  new ChartColors(Color.FromArgb(0xff, 0xff, 0x00, 0xdc), Color.FromArgb(0x68, 0xff, 0xcc, 0xee),Color.FromArgb(0xc8, 0xff, 0x77, 0xee)) },
                { 11, new ChartColors(Color.FromArgb(0xff, 0xff, 0x00, 0x6e), Color.FromArgb(0x68, 0xff, 0xcc, 0xdd),Color.FromArgb(0xc8, 0xff, 0x77, 0xaa)) },
            };
